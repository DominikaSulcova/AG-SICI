...
% ----- decide output parameters -----
AGSICI_P2_default.peak = {'P25' 'N75' 'N100' 'P180'};                               % peaks of interest
AGSICI_P2_default.center = [0.025 0.075 0.1 0.2];                                           % default starting latencies
AGSICI_P2_default.span = [0.015 0.03 0.06 0.06];                                             % span of the extraction window
AGSICI_P2_default.eoi = {{'C1' 'C3' 'CP5'} {'Cz'} {'Fz' 'FC2' 'F4'} {'Cz'}};        % electrodes of interest
...
clear col_fig1 col_fig2 s c figure_title fig axis_counter k polarity e i data_visual data_topoplot a subj figure_name
